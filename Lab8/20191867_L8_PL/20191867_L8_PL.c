...
/* Función valida se ingreso un numero correcto (en caracter) y se le da el valor numerico a una variable numero
Entradas: Ninguna
Salidas: Ninguna
*/
...
int main (void){
	...
	while(1){ //Bucle infinito
		if (inicio){ //Condicional para que se envie el mensaje de inicio al iniciar el programa o al culminar una señal
			...
			Enviar_cadena(mEspacio);
			//Se repite la señal numero veces
			for(i=0;i<numero;i++){
				genera_senal();
			}
			//******************
